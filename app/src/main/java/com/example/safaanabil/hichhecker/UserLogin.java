                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if (status) {
                                        Toast.makeText(UserLogin.this, "username and password is correct", Toast.LENGTH_SHORT).show();
                                        ...
                                        //Toast.makeText(UserLogin.this, "" + token + "    " + name + "   " + id+"   "+group_id, Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(UserLogin.this, "username and password is false", Toast.LENGTH_SHORT).show();
                                    }
